...
import me.ahmedashour.skiller.adapters.SkillsRecyclerAdapter;
import me.ahmedashour.skiller.model.misc.Skill;
import me.ahmedashour.skiller.viewmodels.SkillsViewModel;
...
public class SkillsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        skillsViewModel.getSkills().observe(getViewLifecycleOwner(), new Observer<List<Skill>>() {
            @Override
